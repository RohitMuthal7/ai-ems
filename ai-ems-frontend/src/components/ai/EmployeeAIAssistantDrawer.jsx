...
// ===========================================================================
// File: src/components/ai/EmployeeAIAssistantDrawer.jsx
// Employee AI Assistant Drawer
// ===========================================================================

export default function EmployeeAIAssistantDrawer({
    open,
    onClose,
}) {
    ...
    return (
        <>
            ...
            <aside
                role="dialog"
                aria-modal="true"
                aria-labelledby="employee-ai-assistant-title"
                className="fixed right-0 top-0 z-50 flex h-screen w-full max-w-[560px] flex-col overflow-hidden border-l border-[#ced0c8]/50 bg-white shadow-2xl shadow-[#0c1d27]/10"
            >
                ...
                <header className="shrink-0 border-b border-[#ced0c8]/50 bg-[#f8f9f7]">
                    ...
                    <div className="flex items-center justify-between px-5 py-4 md:px-6">
                        ...
                        <div className="flex min-w-0 items-center gap-3">
                            ...
                            <div className="relative flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-[#31749b] text-white shadow-sm">
                            ...
                            <div className="min-w-0">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <h2
                                        id="employee-ai-assistant-title"
                                        className="truncate text-base font-bold text-[#0c1d27]"
                                    >
                                        AI Assistant
                                    </h2>

                                    <span className="inline-flex items-center gap-1 rounded-full border border-[#b9d9ea]/60 bg-[#ecf4f9] px-2 py-0.5 text-[8px] font-bold uppercase tracking-wider text-[#31749b]">
                        ...
                        <button
                            type="button"
                            onClick={onClose}
                            aria-label="Close Employee AI assistant"
