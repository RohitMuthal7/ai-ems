...
// ===========================================================================
// File: src/components/departments/DepartmentPagination.jsx
// ===========================================================================
    ...
    return (
        <div className="flex flex-col gap-3 border-t border-[#ced0c8]/50 bg-[#f8f9f7] px-5 py-3.5 sm:flex-row sm:items-center sm:justify-between md:px-6">
            ...
            <div className="flex items-center gap-1.5">
                ...
                <span className="hidden min-w-[76px] text-center text-[9px] font-bold uppercase tracking-wider text-[#9ca191] sm:block">
                    Navigation
                </span>
